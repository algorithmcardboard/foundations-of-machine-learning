...
\begin{description}
  ...
  \item{Solution:}  We know that
    ...
    Also, \( \langle \phi(x_{i}), \phi(y_{i}) \rangle \) is a positive scalar.  When a scalar is raised to a positive power (n in our case) and summed with N other positive scalar, we get a positive scalar as our answer.  Hence
    \begin{equation*}
