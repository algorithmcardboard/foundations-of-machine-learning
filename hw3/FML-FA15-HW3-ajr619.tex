...
\begin{description}
  ...
  \item{Proof:} \\
    ...
    \begin{align*}
      ...
      = & [ \frac{\log_2{\frac{1}{1 - r_{t}}}}{2}] \\
      = & [ \frac{\log_2{\frac{1}{1 - \frac{\mid E_{1} \mid}{\mid E_{t} \mid}}}}{2}] \\
      = & [ \frac{\log_2{\frac{\mid E_{t} \mid}{\mid E_{t} \mid - \mid E_{1} \mid}}}{2}] \\
      = & [ \frac{\log_2{\frac{\mid E_{t} \mid}{\mid E_{0} \mid}}}{2}] \\
      = & [ \frac{\log_2{\mid E_{t} \mid} - \log_2{\mid E_{0} \mid}}{2}] \\
      = & [ \frac{\log_2{\mid E_{t} \mid} - \log_2{\mid E_{t+1} \mid}}{2}] \\
