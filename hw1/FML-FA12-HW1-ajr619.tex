...
\subsection*{1}
\begin{description}
  \item[Algorithm \( \mathcal{A} \):] Given a sample \( \mathcal{S} \), Let the algorithm consists of returning the tightest interval I' = \(I_{s}\) containing all points labeled with 1.
